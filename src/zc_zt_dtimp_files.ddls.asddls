...
@EndUserText.label: 'Projection View for ZR_ZT_DTIMP_FILES'
define root view entity ZC_ZT_DTIMP_FILES
  provider contract transactional_query
  as projection on ZR_ZT_DTIMP_FILES
{
  key UUID,
      UuidConf,
  ...
  virtual  ApplicationLogUrl    : abap.string( 256 ),
           ...
           _configuration : redirected to ZC_ZT_DTIMP_CONF
}
